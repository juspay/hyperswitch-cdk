...
def lambda_handler(event, context):
    try:
        ...
        if event['RequestType'] == 'Create':
          ...
          upload_file_from_url("https://hyperswitch-bucket.s3.amazonaws.com/v1.111.0/schema.sql", "hyperswitch-schema-${process.env.CDK_DEFAULT_ACCOUNT}-${process.env.CDK_DEFAULT_REGION}", "schema.sql")
