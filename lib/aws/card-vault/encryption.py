...
LOCKER__AWS_KMS__KEY_ID={pl("kms_id")}
LOCKER__AWS_KMS__REGION={pl("region")}
LOCKER__SECRETS_MANAGEMENT__AWS_KMS__KEY_ID={pl("kms_id")}
LOCKER__SECRETS_MANAGEMENT__AWS_KMS__REGION={pl("region")}
LOCKER__SECRETS_MANAGEMENT__SECRETS_MANAGER=aws_kms
LOCKER__TENANT_SECRETS__PUBLIC__MASTER_KEY={enc_pl("master_key")}
LOCKER__TENANT_SECRETS__PUBLIC__PUBLIC_KEY={enc_pl("public_key")}
LOCKER__TENANT_SECRETS__PUBLIC__SCHEMA=public
LOCKER__API_CLIENT__CLIENT_IDLE_TIMEOUT=30
