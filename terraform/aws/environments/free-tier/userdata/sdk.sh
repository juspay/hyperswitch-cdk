...
cd /
sudo curl -L https://raw.githubusercontent.com/juspay/hyperswitch-cdk/refs/heads/main/terraform/aws/environments/free-tier/userdata/sdk_assets.zip --output sdk_assets.zip
